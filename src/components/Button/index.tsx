...
export const Button = ({ children, variant = 'primary', size = "md" }: ButtonProps) => {
    const buttonStyles = {
        base: "flex justify-center items-center gap-2 text-nowrap leading-none hover:cursor-pointer transition-colors duration-200 font-medium rounded-full transition-padding py-2.5",
        variant: {
